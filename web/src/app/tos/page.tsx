        ...
        <div className="profile">
          <div className="profile-header no-avatar">
            <div className="profile-info">
              <h1 className="profile-name">{copy.legal.tos.title}</h1>
              <p className="profile-username">{copy.legal.tos.subtitle}</p>
            </div>
          </div>
            ...
            <div className="pinned-content">
              <div style={{ marginTop: '16px', lineHeight: '1.6' }}>
                <p style={{ color: 'var(--text-secondary)', marginBottom: '16px' }}>
                  <strong>{t('texts.effective_date', { date: copy.legal.tos.effectiveDate })}</strong>
                </p>
                {copy.legal.tos.sections.map((section, idx) => (
                  <div key={idx}>
